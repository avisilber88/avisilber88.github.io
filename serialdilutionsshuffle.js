...
// if (exponency.substring(0,1)==="+"){
		...
		// var answerStringFinal=answerString.substring(0,eSpot)+"*10^"+exponency;
			...
			serialDilution = Math.pow(n2, n1);
			if (questionType==2){
			serialDilution=n2/n1;
			// console.error(n1+" "+ n2+ " "+serialDilution);
			}
			if (questionType==3){
			}
			// var moles = n1*Math.pow(10, m1)/mW;
	...
	resetQuestionDecimals((serialDilution));
	};
	...
	var setupAnswersDecimals = function (answer1, n2) {
		...
		if (questionType==3){
		thisAnswer= numberThree+"/"+answer1+"";
		}
				//alert(thisAnswer);
...
var getCorrectChemicalFormula=function(moleculeName){
	...
	var resetQuestion=function(){
		...
		numberThree =(Math.floor(Math.random()*100))+1;
...
// the below text would have generated a random unit type.
		...
		stepToCheckNumber=Math.floor(Math.random()*number)+1;
		
if (stepToCheckNumber==1){
stepToCheck="1st";
}
else if (stepToCheckNumber==2){
stepToCheck="2nd";
}
else if (stepToCheckNumber==3){
stepToCheck="3rd";
}
else if (stepToCheckNumber==4){
stepToCheck="4th";
}
else if (stepToCheckNumber==5){
stepToCheck="5th";
}
else if (stepToCheckNumber==6){
stepToCheck="6th";
}
else if (stepToCheckNumber==7){
stepToCheck="7th";
}
else if (stepToCheckNumber==8){
stepToCheck="8th";
}
else if (stepToCheckNumber==9){
stepToCheck="9th";
}
else if (stepToCheckNumber==10){
stepToCheck="10th";
}
...
if (questionType==0){ //normal serial dilution with final answer question
if (score>19){
...
else if (questionType==2){ // slightly tricky one where they just look for a ratio in general
if (score>19){
document.getElementById("num1").innerHTML = "your supervisor provides you with a "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " solution, and asks you to make a "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step). <br><br> What is the dilution factor if you add "+ concentrateVolume+" uL "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " to "+ diluentVolume + " uL of diluent?<br>(make sure to frame it as a fraction ex: '1/4')";
}
else {	
document.getElementById("num1").innerHTML = "Your supervisor provides you with a "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " solution, and asks you to make a "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step). <br><br> What is the dilution factor if you add "+ concentrateVolume+" uL "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " to "+ diluentVolume + " uL of diluent?<br>(make sure to frame it as a fraction ex: '1/4')";
}
}
else { // slightly tricky one where they want to know the actual volume.
if (score>19){
document.getElementById("num1").innerHTML = "your supervisor provides you with a "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " solution, and asks you to make a "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step). <br><br> After you have performed the "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step) as requested, what is the final concentration in "+units1+"/"+units2+" of " + formulaName + " at the final step? (leave your answer in the form of a fraction ex: 75/400)";
}
else {	
document.getElementById("num1").innerHTML = "Your supervisor provides you with a "+numberThree+" "+units1+"/"+units2+" of " + formulaName + " solution, and asks you to make a "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step). <br><br> After you have performed the "+number+"-step "+numbertwo+"-fold dilution ("+numbertwo+"<sup>-1</sup> at each step) as requested, what is the final concentration in "+units1+"/"+units2+" of " + formulaName + " at the final step? (leave your answer in the form of a fraction ex: 75/400)";
}
...
numbertwo=concentrateVolume+diluentVolume;
}

    ...
    var generateDropdowns = function (dataArray) {
        ...
        $('#submitAssignment').click(function () {
			...
			for (var i = 1; i < dataArray.length; i++){
				...
				passArray.push([dataArray[i][41], dataArray[i][3], dataArray[i][4], dataArray[i][42], dataArray[i][38]]);
				}
			}
			generatePasses();
            $(".pickassignment").slideToggle();
...
//Step 2B: Grouping Style
    ...
    var generatePasses = function () {
		...
		tableWriter=tableWriter+'\n'+'<tr  '+tableStyle+">"+'<td '+tableStyle+">"+"Dear "+passArray[i][0] +"(" +passArray[i][3]+") please give this pass to "+passArray[i][1]+ " "+passArray[i][2]+" in pd "+passArray[i][4]+" so they can participate in "+programName+" on " + dateName + " at " + timeName + " in "+locationName+"."+ '</td></tr>';

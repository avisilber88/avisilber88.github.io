...
wrongCompound3="";
	...
	//alert ("done");
			wrongCompound1 = getOrganicPrefix(carbonNumber)+getOrganicSuffix(wrongOrganicQuality1)
			wrongCompound2 = getOrganicPrefix(carbonNumber)+getOrganicSuffix(wrongOrganicQuality2); //gohere813
			wrongCompound3 = getOrganicPrefix(carbonNumber)+getOrganicSuffix(wrongOrganicQuality3);  //gohere813
			break;	
			case 2: //wrong # of carbons.
			
				//alert ("done3");
			wrongCompound1 = getOrganicPrefix(Math.floor(Math.random()*10)+1)+getOrganicSuffix(Math.floor(Math.random()*4)+1); //gohere813
			wrongCompound2 = getOrganicPrefix(Math.floor(Math.random()*10)+1)+getOrganicSuffix(Math.floor(Math.random()*4)+1); //gohere813
			wrongCompound3 = getOrganicPrefix(Math.floor(Math.random()*10)+1)+getOrganicSuffix(Math.floor(Math.random()*4)+1); //gohere813
			break;
		}
...
answer=getOrganicPrefix(carbonNumber)+getOrganicSuffix(organicQuality);
		var answers = [];
		answers[0]=answer;

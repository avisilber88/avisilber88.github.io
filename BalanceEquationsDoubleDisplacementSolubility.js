...
function addLevelCompleted(nameis, dateis, levelcomplete) {
	...
	var productOneStateSelect = "";
	var productOneStateAnswer = "";
	var productTwoStateSelect = "";
	var productTwoStateAnswer = "";
...
var cation;
	var getRandomCation = function (charge) {
		cation = ["", 0, false, ""]; //where "" is cation and "" is molar mass;
	...
	var checkState = function(thecation, theanion){
		thecation=thecation.replace(/[{()}]/g, '');
		theanion=theanion.replace(/[{()}]/g, '');
		if (thecation == "Al"){
			if ((theanion=="PO&#8324")||(theanion=="CO&#8323")){
				return "s";
			}
			else{
				return "aq";
		...
		else if (thecation =="Na"){
			return "aq";
		}
		else if (thecation == "Ba"){
			if ((theanion=="PO&#8324")||(theanion=="CO&#8323")||(theanion=="OH")||(theanion=="SO&#8324")){
				return "s";
			}
			else{
				return "aq";
		...
		else if (thecation == "Ca"){
			if ((theanion=="PO&#8324")||(theanion=="CO&#8323")||(theanion=="OH")){
				return "s";
			}
			else{
				return "aq";
		...
		else if (thecation == "Cu"){
			if ((theanion=="PO&#8324")||(theanion=="CO&#8323")||(theanion=="OH")||(theanion=="I")){
				return "s";
			}
			else{
				return "aq";
		...
		else if (thecation == "Pb"){
			if ((theanion=="PO&#8324")||(theanion=="CO&#8323")||(theanion=="OH")||(theanion=="SO&#8324")||(theanion=="Cl")||(theanion=="Br")||(theanion=="I")||(theanion=="OH")){
				return "s";
			}
			else{
				return "aq";
	...
	var checkReaction = function (cation1, cation2, anion1, anion2){
	let firstState = checkState(cation1, anion2);
	let secondState = checkState(cation2, anion1);
	if ((firstState=="aq")&&(secondState=="aq")){
		return "NR";
	}
	else{
		return "Reaction";
	...
	var checkReactionMath = function (cation1, cation2, anion1, anion2){
	let firstState = checkState(cation1, anion2);
	let secondState = checkState(cation2, anion1);
	if ((firstState=="aq")&&(secondState=="aq")){
		return false;
...
var startedNumber = 0;
	...
	var resetQuestion = function () {
		if (startedNumber == 0) {
			...
			generateQuestionTypes("No Reaction");
			generateQuestionTypes("Reaction");
			stardedNumber = 1;
		}
		var selected = $('#reactionTypes').find('option:selected');
		...
		if (questionType == "combustion") {
			...
			m = n.getMonth() + 1;
			d = n.getDate();
			randomunitnum4 = (Math.floor(Math.random() * 10) + 1);
			carbonNumber = randomunitnum4;
			//alert (cationCharge);
			//var cationArray = getRandomCation(cationCharge);
			//carbonNumber=1;
			if (carbonNumber == 1) {
				randomunitnum5 = (Math.floor(Math.random() * 2)) * 3 + 1;
			} else {
				randomunitnum5 = (Math.floor(Math.random() * 4) + 1);
			}
			organicQuality = randomunitnum5;
			...
			randomunitnum3 = (Math.floor(Math.random() * 4) + 1);
			cationCharge = randomunitnum3;
			//alert (cationCharge);
			cationArray = getRandomCation(cationCharge);
			randomunitnum2 = (Math.floor(Math.random() * 3) + 1);
			...
			units1 = getUnit(mag1) + "g";
			units2 = getUnit(mag2) + "L";
			//units1 = number+"grams";
			...
			if (setElementsToDD == 0) {
				document.getElementById("co2").innerHTML = "<font color = 'black'><select id = 'firstproductoptions' name = 'firstproductoptions'> <option value = 'firstproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select><sub><select id = 'firstproductstateoptions' name = 'firstproductstateoptions'> <option value = 'solidstate'> (s) </option> <option value = 'liquidstate'> (l) </option><option value = 'aqueousstate'> (aq) </option><option value = 'gasstate'> (g) </option></select></sub>";
				//above will be updated later
				document.getElementById("h2o").innerHTML = "<font color = 'black'><select id = 'secondproductoptions' name = 'secondproductoptions'> <option value = 'secondproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select><sub><select id = 'secondproductstateoptions' name = 'secondproductstateoptions'> <option value = 'solidstate'> (s) </option> <option value = 'liquidstate'> (l) </option><option value = 'aqueousstate'> (aq) </option><option value = 'gasstate'> (g) </option></select></sub>";
				setElementsToDD = 1;
			}
			//above will be updated later.
			//below is ubiquitous
		...
		while (testingIt){
			...
			while ((anionTwoArray[0]==anionArray[0])){
				...
				testingIt=checkReactionMath(cationTwoArray[0], cationArray[0], anionArray[0], anionTwoArray[0]);
			...
			stateOne=checkState(cationArray[0], anionTwoArray[0]);
			stateTwo=checkState(cationTwoArray[0], anionArray[0]);
			reactionStatus=checkReaction(cationArray[0], cationTwoArray[0], anionArray[0], anionTwoArray[0]);
			
			// alert (cationArray[0]+ anionTwoArray[0]+ " "+stateOne+" and " + cationTwoArray[0]+ anionArray[0]+" "+stateTwo + " so the reaction is "+reactionStatus);
			...
			if (score > 19) {
				document.getElementById("num1").innerHTML = "find the products, and their states for the reaction of " + balancedReactantOneFormulaArray[0] + " and " + balancedReactantTwoFormulaArray[0]; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			} else if (score > 9) {
				document.getElementById("num1").innerHTML = "Find the products, and their states for the reaction of " + balancedReactantOneFormulaArray[0] + " and " + balancedReactantTwoFormulaArray[0] + "."; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>.?";
			} else {
				document.getElementById("num1").innerHTML = "Find the products, and their states for the reaction of " + balancedReactantOneFormulaArray[0] + " and " + balancedReactantTwoFormulaArray[0]; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
	...
	selectInfo = "" + document.getElementById("reactionTypes").options[document.getElementById("reactionTypes").selectedIndex].value;
	// alert (selectInfo);
	questionName = "";
	...
	} else if (selectInfo == "No Reaction") {
		questionName = "NR";
	} else if (selectInfo == "Reaction") {
		questionName = "Reaction";
	}
		return questionName;
	}
	...
	$(function () {
		$('#secondproductstateoptions').change(function () {
			productOneStateSelect = $('#secondproductstateoptions').find('option:selected');
			// productTwoFormulaSelect = document.getElementById("secondproductoptions").options[document.getElementById("secondproductoptions").selectedIndex].innerHTML;
			resetAnswerProposal();
		});
	});
	$(function () {
		$('#firstproductstateoptions').change(function () {
			productTwoStateSelect = $('#firstproductstateoptions').find('option:selected');
			// productTwoFormulaSelect = document.getElementById("secondproductoptions").options[document.getElementById("secondproductoptions").selectedIndex].innerHTML;
			resetAnswerProposal();
		});
	});
	...
	var resetAnswerProposal = function () {
		if (questionType == "combustion") {
			...
			var productOneStateSelect = document.getElementById("firstproductstateoptions").options[document.getElementById("firstproductstateoptions").selectedIndex].innerHTML;
			var productTwoStateSelect = document.getElementById("secondproductstateoptions").options[document.getElementById("secondproductstateoptions").selectedIndex].innerHTML;
			if (organicCompoundCoefficient == 1) {
				organicCompoundCoefficientWrite = (organicCompoundCoefficient + "").replace(/1/g, '');
			}
			var oxygenCoefficientWrite = oxygenCoefficient;
			...
			// console.warn(productOneStateAnswer+" "+productOneStateSelect+" "+productTwoStateAnswer+" "+productTwoStateSelect);
			proposedAnswerStatement=organicCompoundCoefficientWrite + balancedReactantOneFormulaArray[0] + " + " + oxygenCoefficientWrite + balancedReactantTwoFormulaArray[0] + " -> " + cationcoefficientWrite + productOneFormulaSelect.innerHTML +"<sub>"+productOneStateSelect+"</sub>" +  " + " + anioncoefficientWrite + productTwoFormulaSelect.innerHTML+"<sub>"+productOneStateSelect+"</sub>";
			document.getElementById("youranswer").innerHTML = "Your proposed equation:  " + organicCompoundCoefficientWrite + balancedReactantOneFormulaArray[0] + " + " + oxygenCoefficientWrite + balancedReactantTwoFormulaArray[0] + " -> " + cationcoefficientWrite + productOneFormulaSelect+"<sub>"+productOneStateSelect+"</sub>" + " + " + anioncoefficientWrite + productTwoFormulaSelect+"<sub>"+productOneStateSelect+"</sub>";
	...
	$('#submitButton').click(function () {
		...
		if (getQuestionTypeFromName() == "selectAgain"){
			...
			alert("You selected '" + document.getElementById("reactionTypes").options[document.getElementById("reactionTypes").selectedIndex].value + "' that was incorrect. You may try again.");
			score = score - 1;
			$('#score').text("Score = " + score);
			$('#scoremessage').text(specialMessage(score));
			// console.log(questionType + " given " + getQuestionTypeFromName());
		}
		else if (getQuestionTypeFromName() == "NR"){
			score = score + 1;
				addLevelCompleted(whatnameis, m+"/"+d+"/"+y, parseInt(score));
					$('#score').text("Score = " + score);
					$('#scoremessage').text(specialMessage(score));
		...
		if (questionType == "combustion") {
			...
			if ((cationcoefficient != null) && (anioncoefficient != null) && (organicCompoundCoefficient != null) && (oxygenCoefficient != null)) {
				...
				addLevelCompleted(whatnameis, m+"/"+d+"/"+y, parseInt(score));
					...
					alert("Incorrect, you either didn't balance the products properly, or you did not properly predict their states.");
	...
	//	alert (cationName+"");
			...
			var productOneStateSelect = document.getElementById("firstproductstateoptions").options[document.getElementById("firstproductstateoptions").selectedIndex].innerHTML;
			var productTwoStateSelect = document.getElementById("secondproductstateoptions").options[document.getElementById("secondproductstateoptions").selectedIndex].innerHTML;
			var productOneStateAnswer = "("+stateOne+")";
			var productTwoStateAnswer = "("+stateTwo+")";
...
//UPDATED TO TURN OFF COEFFICIENTS
cationcoefficientWrite=("" + catCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '');
anioncoefficientWrite=("" + anCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '');
organicCompoundCoefficientWrite=("" + organicCompoundCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '');
oxygenCoefficientWrite=("" + oxygenCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '');

			console.warn((("" + productOneStateAnswer).toUpperCase().replace(/\s/g, '') == ("" + productOneStateSelect).toUpperCase().replace(/\s/g, ''))+" "+(productTwoStateAnswer==productTwoStateSelect));
//END UPDATE
			if ((cationcoefficientWrite != null) && (anioncoefficientWrite != null) && (organicCompoundCoefficientWrite != null) && (oxygenCoefficientWrite != null) && (productOneFormulaSelect != null) && (productTwoFormulaSelect != null)) {
				//alert (cationcoefficientWrite +" " +catCoefficientAnswerWrite +". then "+anioncoefficientWrite +" " +anCoefficientAnswerWrite +". then "+organicCompoundCoefficientWrite +" " +organicCompoundCoefficientAnswerWrite +". then "+oxygenCoefficientWrite +" " +oxygenCoefficientAnswerWrite +".");
				if ((("" + cationcoefficientWrite).toUpperCase().replace(/\s/g, '') == ("" + catCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '')) && (("" + anioncoefficientWrite).toUpperCase().replace(/\s/g, '') == ("" + anCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '')) && (("" + organicCompoundCoefficientWrite).toUpperCase().replace(/\s/g, '') == ("" + organicCompoundCoefficientAnswerWrite).toUpperCase().replace(/\s/g, '')) && (("" + oxygenCoefficientWrite).toUpperCase().replace(/\s/g, '') == ("" + oxygenCoefficientAnswerWrite).toUpperCase().replace(/\s/g, ''))&& ((productTwoFormulaSelect) == (productTwoFormulaAnswer[0]).replace(/\s/g, ''))&& ((productOneFormulaSelect) == (""+productOneFormulaAnswer[0]).replace(/\s/g, ''))&&(("" + productOneStateAnswer).toUpperCase().replace(/\s/g, '') == ("" + productOneStateSelect).toUpperCase().replace(/\s/g, ''))&&(("" + productTwoStateAnswer).toUpperCase().replace(/\s/g, '') == ("" + productTwoStateSelect).toUpperCase().replace(/\s/g, ''))) {

...
//end of the things to replace
	...
	let coinFlip = Math.floor(Math.random() * 2);
		...
		if ((questionType == 2) || (questionType == 3)) {
			...
			wrongAnswer2 = totalTime + " " + timeUnit;
			wrongAnswer3 = totalTime / 2 + " " + timeUnit;
		} else if (questionType == 1) {
			answer = endingMass + " g";
			wrongAnswer1 = endingMass / 2 + " g";
			if (coinFlip == 0) {
				wrongAnswer1 = endingMass * 2 + " g";
			}
			wrongAnswer2 = startingMass - endingMass + " g";
			wrongAnswer3 = startingMass + endingMass + " g";
		} else if (questionType == 4) {

			answer = fractionRemaining;
			wrongAnswer1 = "1/" + (demRemaining * 4);
			wrongAnswer2 = "1/" + (demRemaining * 8);
			wrongAnswer3 = "1/" + (demRemaining / 2);
			if (coinFlip == 0) {
				wrongAnswer1 = "1/" + (demRemaining / 2);
				wrongAnswer2 = "1/" + (demRemaining * 2);
				wrongAnswer3 = "1/" + (demRemaining / 4);
			}
	...
	var resetQuestion = function () {
		...
		case 3:
			if (score > 19) {
				document.getElementById("num1").innerHTML = "a " + startingMass + " g sample of radioactive isotope is tested after " + totalTime + " " + timeUnit + " and only " + endingMass + " g remains. What is the half-life of the sample (in " + timeUnit + ")?";
		...
		case 4:
			if (score > 19) {
				document.getElementById("num1").innerHTML = "a isotope has a half-life of " + halfLifeTime + " " + timeUnit + ". What fraction of the original quantity remains after " + totalTime + " " + timeUnit + "?";

			} else {
				document.getElementById("num1").innerHTML = "An isotope has a half-life of " + halfLifeTime + " " + timeUnit + ". What fraction of the original quantity remains after " + totalTime + " " + timeUnit + "?";
		...
		setupAnswers(questionType, halfLifeTime, startingMass, endingMass, numHalfLives, totalTime, demRemaining, fractionRemaining, timeUnit);
	};

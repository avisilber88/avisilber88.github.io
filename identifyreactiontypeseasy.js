	...
	var resetQuestion = function () {
		...
		if (questionType == "synthesis") {
			...
			if (carbonNumber == 1) {
				...
				var randomunitnum5 = (Math.floor(Math.random() * 3) + 1); //changed this to exclude alcohols
			}
			...
			var randomunitnum3 = (Math.floor(Math.random() * 3) + 1); //altered this to make it easier 4/9/2020 by limiting it to charges of 3
			...
			//below make our second reactant
			var randomunitnum8 = (Math.floor(Math.random() * 10) + 1);
			var randomunitnum6 = (Math.floor(Math.random() * 3) + 1); //4/9/20 made it 3 instead of 4 to make it easier again.
			cationTwoCharge = randomunitnum6;
			cationTwoArray = getRandomCation(cationTwoCharge);

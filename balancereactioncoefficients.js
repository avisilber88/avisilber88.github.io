...
//end of the things to replace
	...
	var getRandomAnionGas = function (charge) {
	...
	var setupInputs = function () {
		...
		document.getElementById("coefficientNumOne").innerHTML = "<input type='text'  style='width: 80px;' name='organicCompoundCoefficient' id = 'organicCompoundCoefficient' value='coefficient?'></input>"; //<font color= 'white'>";
		document.getElementById("coefficientNumTwo").innerHTML = "<input  type='text'  style='width: 80px;' name='oxygenCoefficient' id = 'oxygenCoefficient' value='coefficient?'> <font color= 'white'></input>"; //<font color= 'white'>";
		document.getElementById("coefficientNumThree").innerHTML = "<input  type='text'  style='width: 80px;' name='cationcoefficient' id = 'cationcoefficient' value='coefficient?'> <font color= 'white'></input>"; //<font color= 'white'>";
		document.getElementById("coefficientNumFour").innerHTML = "<input type='text'  style='width: 80px;' name='anioncoefficient' id = 'anioncoefficient' value='coefficient?'></input> "; //<font color= 'white'>";
	...
	var resetQuestion = function () {
		if (startedNumber == 0) {
			// alert ("hi");
			$('#reactionTypes').empty();
			generateQuestionTypes("Select Type");
		...
		if (questionType == "synthesis") {
			...
			document.getElementById("organicCompoundName").innerHTML = "";
			//juicy code goes here
			getReactionArray();
			document.getElementById("co2").innerHTML = "" + reactionArray[5]; // CO<sub>2</sub>";
			document.getElementById("oxygen").innerHTML = "" + reactionArray[3]; // O<sub>2</sub>";
			// document.getElementById("h2o").innerHTML = ""; // H<sub>2</sub>O";
			document.getElementById("organicCompoundName").innerHTML = "" + reactionArray[1];

			if (score > 19) {
				document.getElementById("num1").innerHTML = "balance and classify the below reaction "; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			} else if (score > 9) {
				document.getElementById("num1").innerHTML = "Balance and classify the below reaction. "; // + organicCompoundName + "."; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>.?";
			} else {
				document.getElementById("num1").innerHTML = "Balance and classify the below reaction "; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			...
			//fix below
			getReactionArray();
			document.getElementById("h2o").innerHTML = "" + reactionArray[3]; // CO<sub>2</sub>";
			document.getElementById("co2").innerHTML = "" + reactionArray[1]; // O<sub>2</sub>";
			// document.getElementById("h2o").innerHTML = ""; // H<sub>2</sub>O";
			document.getElementById("organicCompoundName").innerHTML = "" + reactionArray[5];
			...
			if (setElementsToDD == 0) {
				// let product1writing = getBalancedIonicCompound(cationArray, cationCharge, anionTwoArray, anionTwoCharge);
				// let product1writing = document.getElementById("firstproductoptions").options[document.getElementById("firstproductoptions").selectedIndex].value;
				//	alert (cationName+"");
				
				// let product2writing = getBalancedIonicCompound(cationTwoArray, cationTwoCharge, anionArray, anionCharge);

				document.getElementById("co2").innerHTML = "<font color = 'white'><select id = 'firstproductoptions' name = 'firstproductoptions'> <option value = 'firstproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select>";
				//above will be updated later
				document.getElementById("h2o").innerHTML = "<font color = 'white'><select id = 'secondproductoptions' name = 'secondproductoptions'> <option value = 'secondproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select>";
				setElementsToDD = 0;
				
				document.getElementById('firstproductoptions').hidden=true;
				
				document.getElementById('secondproductoptions').hidden=true;
			}
			//above will be updated later.
			//below is ubiquitous
			n = new Date();
			...
			// alert ("yo");
				product1writing = getBalancedIonicCompound(cationArray, cationCharge, anionTwoArray, anionTwoCharge);
				// let product1writing = document.getElementById("firstproductoptions").options[document.getElementById("firstproductoptions").selectedIndex].value;
				//	alert (cationName+"");
				
				product2writing = getBalancedIonicCompound(cationTwoArray, cationTwoCharge, anionArray, anionCharge);

				document.getElementById("co2").innerHTML = "<font color = 'white'>"+product1writing[0]+"<select id = 'firstproductoptions' name = 'firstproductoptions'> <option value = 'firstproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select>";
				//above will be updated later
				document.getElementById("h2o").innerHTML = "<font color = 'white'>"+product2writing[0]+"<select id = 'secondproductoptions' name = 'secondproductoptions'> <option value = 'secondproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select>";
				// setElementsToDD = 0;
			...
			if (setElementsToSD == 0) {
				// let product3writing = getBalancedIonicCompound(cationArray, cationCharge, anionTwoArray, anionTwoCharge);
				...
				//above will be updated later
				document.getElementById('firstproductoptions').hidden;
				document.getElementById("h2o").innerHTML = "cation 2";
				setElementsToSD = 0;
			}
			...
			balancedReactantTwoFormulaArray = getBalancedIonicCompound(cationTwoArray, cationTwoCharge, anionTwoArray, anionTwoCharge);
				...
				if (singleAnion) {
					product3writing = getBalancedIonicCompound(cationArray, cationCharge, anionTwoArray, anionTwoCharge)[0];
				} else {
					product3writing = getBalancedIonicCompound(cationTwoArray, cationTwoCharge, anionArray, anionCharge)[0];
				}	
				document.getElementById("co2").innerHTML = "<font color = 'white'>"+product3writing+"<select id = 'firstproductoptions' name = 'firstproductoptions'> <option value = 'firstproductoption1'> cation1 </option> <option value = 'cation2'> cation2 </option><option value = 'cation3'> cation3 </option><option value = 'cation4'> cation4 </option> </select>";
				//above will be updated later
				document.getElementById('firstproductoptions').hidden=true;
			document.getElementById("organicCompoundName").innerHTML = " " + balancedReactantOneFormulaArray[0]; //1st reactant
			// if (cationTwo[3].+" ("+cationTwoArray[3]+")"; //2nd reactant
			if (singleAnion) {
				document.getElementById("oxygen").innerHTML = " " + anionTwoArray[0].replace(/[()]/g, '') + "&#8322"; //
				generateOptionsSingleAnion(cationArray, anionArray, anionTwoArray);
				document.getElementById("h2o").innerHTML = " " + anionArray[0].replace(/[()]/g, '') + "&#8322";
			} else {
				document.getElementById("oxygen").innerHTML = " " + cationTwoArray[0].replace(/[()]/g, ''); //
				generateOptionsSingleCation(cationArray, anionArray, cationTwoArray);

				document.getElementById("h2o").innerHTML = " " + cationArray[0].replace(/[()]/g, '');
			}
		if (score > 19) {
			document.getElementById("num1").innerHTML = "balance and classify the below reaction "; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
		} else if (score > 9) {
	...
	if (questionType == "synthesis") {
		...
		console.log(product1writing);
		console.warn(product2writing);
		proposedAnswerStatement = organicCompoundCoefficientWrite + balancedReactantOneFormulaArray[0] + " + " + oxygenCoefficientWrite + balancedReactantTwoFormulaArray[0] + " -> " + cationcoefficientWrite + product1writing[0] + " + " + anioncoefficientWrite + product2writing[0];
		document.getElementById("youranswer").innerHTML = "Your proposed equation:  " + organicCompoundCoefficientWrite + balancedReactantOneFormulaArray[0] + " + " + oxygenCoefficientWrite + balancedReactantTwoFormulaArray[0] + " -> " + cationcoefficientWrite + product1writing[0] + " + " + anioncoefficientWrite + product2writing[0];
		...
		var organicCompoundCoefficient = document.getElementById("organicCompoundCoefficient").value; //gets the 1st reactant coefficient
		var organicCompoundCoefficientWrite = organicCompoundCoefficient;
		var productOneFormulaSelect = product3writing;//document.getElementById("firstproductoptions").options[document.getElementById("firstproductoptions").selectedIndex].innerHTML;
		// //	alert (cationName+"");
		// var productTwoFormulaSelect = document.getElementById("secondproductoptions").options[document.getElementById("secondproductoptions").selectedIndex].innerHTML;
		if (organicCompoundCoefficient == 1) {
			organicCompoundCoefficientWrite = (organicCompoundCoefficient + "").replace(/1/g, '');
	...
	else if (selectInfo == "Select Type") {
		questionName = "selectAgain";
	...
	$('#submitButton').click(function () {
		...
		if (getQuestionTypeFromName() == "selectAgain"){
			alert ("You have not selected a reaction type. What type of reaction is this? Select from the pull down menu");
		}
		
		else if (questionType != getQuestionTypeFromName()) {
			...
			if (questionType == "synthesis") {
				...
				// }
				document.getElementById("correctanswer").innerHTML = "The answer to your previous question was:     " + (organicCompoundCoefficientAnswerWrite) + reactionArray[1] + " + " + (oxygenCoefficientAnswerWrite) + reactionArray[3] + " -> " + (catCoefficientAnswerWrite) + reactionArray[5];
				var cationcoefficient = document.getElementById("cationcoefficient").value;
				// var anioncoefficient = document.getElementById("anioncoefficient").value;
				var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				//alert ((anionName)+" "+anionArray[0]);
				if ((cationcoefficient != null) && (oxygenCoefficient != null) && (organicCompoundCoefficient != null)) {
					// alert ("hello");
				...
				if (organicCompoundCoefficient == 1) {
					// alert ("hellogoodbye");
					organicCompoundCoefficientWrite = (organicCompoundCoefficient + "").replace(/1/g, '');
					// alert (organicCompoundCoefficientWrite);
				}
				// var oxygenCoefficientWrite = oxygenCoefficient;
				// if (oxygenCoefficient == 1) {
				// oxygenCoefficientWrite = (oxygenCoefficient + "").replace(/1/g, '');
				...
				document.getElementById("correctanswer").innerHTML = "The answer to your previous question was:     " + (organicCompoundCoefficientAnswerWrite) + reactionArray[5] + " -> " + (catCoefficientAnswerWrite) + reactionArray[1] + " + " + (anCoefficientAnswerWrite) + reactionArray[3];
				var cationcoefficient = document.getElementById("cationcoefficient").value;
				var anioncoefficient = document.getElementById("anioncoefficient").value;
				var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				// var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				//alert ((anionName)+" "+anionArray[0]);
				if ((cationcoefficient != null) && (anioncoefficient != null) && (organicCompoundCoefficient != null)) {
					// alert ("hello");
					//alert (cationcoefficientWrite +" " +catCoefficientAnswerWrite +". then "+anioncoefficientWrite +" " +anCoefficientAnswerWrite +". then "+organicCompoundCoefficientWrite +" " +organicCompoundCoefficientAnswerWrite +". then "+oxygenCoefficientWrite +" " +oxygenCoefficientAnswerWrite +".");
				...
				productOneFormulaSelect = ("" + productOneFormulaAnswer[0]).replace(/\s/g, ''); //ADDED FOR THIS APP
				productTwoFormulaSelect = (productTwoFormulaAnswer[0]).replace(/\s/g, ''); //ADDED FOR THIS APP
				...
				// alert (oxygenCoefficient+"b");
				if (singleAnion){
				document.getElementById("correctanswer").innerHTML = "The answer to your previous question was:     " + (organicCompoundCoefficientAnswerWrite) + balancedReactantOneFormulaArray[0] + " + " + (oxygenCoefficientAnswerWrite) + anionTwoArray[0].replace(/[()]/g, '')+"&#8322" + " -> " + (catCoefficientAnswerWrite) + productOneFormulaAnswer[0] + " + " + (anCoefficientAnswerWrite) + anionArray[0].replace(/[()]/g, '')+"&#8322";
				}
				else{
					document.getElementById("correctanswer").innerHTML = "The answer to your previous question was:     " + (organicCompoundCoefficientAnswerWrite) + balancedReactantOneFormulaArray[0] + " + " + (oxygenCoefficientAnswerWrite) + cationTwoArray[0] + " -> " + (catCoefficientAnswerWrite) + productOneFormulaAnswer[0] + " + " + (anCoefficientAnswerWrite) + cationArray[0];
				}
				var cationcoefficient = document.getElementById("cationcoefficient").value;
				var anioncoefficient = document.getElementById("anioncoefficient").value;
				var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;

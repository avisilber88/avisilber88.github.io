...
// alert(nottargetednum);
    ...
    var groupByGroups = function (numberOfGroups) {
        ...
        for (var k = 0; k < groupOfGroupsArray.length; k++) {
            ...
            document.getElementById(allGroupIds[k]).innerHTML = "<div id = '" + groupIdTag + "'>Group: <input type='text'  name='o' id = '" + groupIdTagNumber + "' value='" + (k + 1) + "' style='width: 35%'></input></div>" + "<div class='card' id = '" + testIdTag + "'><div class='container'> <h4><b>" + testIdName.substring(0, testIdName.indexOf(' ')) + "</b></h4></div></div>";
            ...
            for (var i = 1; i < groupOfGroupsArray[k].length; i++) {
                ...
                document.getElementById(allGroupIds[k]).innerHTML = document.getElementById(allGroupIds[k]).innerHTML + "<div class='card' id = '" + testIdTag + "'><div class='container'> <h4><b>" + testIdName.substring(0, testIdName.indexOf(' ')) + "</b></h4></div></div>";
            ...
            (function (i) {
                ...
                document.getElementById(allStudentBoxIds[i + 0][0]).addEventListener("click", function (e) {
                    if ((!itSelected) && (!lockNames)) {
                        ...
                        document.getElementById(allStudentBoxIds[i][0]).innerHTML = "<div class='container'> <h4><b>" + nameOne.substring(0, nameOne.indexOf(' ')) + "</b></h4></div>";
                        allStudentBoxIds[i][1] = nameOne;
                        document.getElementById(allStudentBoxIds[iOne][0]).innerHTML = "<div class='container'> <h4><b>" + nameTwo.substring(0, nameTwo.indexOf(' ')) + "</b></h4></div>";
...
var generateInvert = function (dataArray) {
       ...
       // for (var g = 0; g < groupCArray.length; g++) {
        ...
        for (var k = 0; k < groupOfGroupsArray.length; k++) {
			...
			console.warn(k+" "+spot);
            document.getElementById(allGroupIds[k]).innerHTML = "<div id = '" + groupIdTag + "'>Group: <input type='text'  name='o' id = '" + groupIdTagNumber + "' value='" + spot + "' style='width: 35%'></input></div>" + "<div class='card' id = '" + testIdTag + "'><div class='container'> <h4><b>" + testIdName.substring(0, testIdName.indexOf(' ')) + "</b></h4></div></div>";
            groupNamesArray.push([groupIdTag + "", groupIdTagNumber + ""]);
            document.getElementById(testIdTag + "").classList.add(groupOfGroupsArray[k][0][2]);

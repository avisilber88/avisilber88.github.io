...
//end of the things to replace
	...
	var wrongCompound3;
	var thisAnswer = "";
	var thisAnswerWrongCuzNegative="";
...
//	answerString=round(answerString,3)+"";
	...
	var resetQuestion = function () {
		...
		questionTypeNumber = 5;//Math.floor(Math.random() * 6) + 1; //set to not include synthesis or decomposition

		switch (questionTypeNumber) {
		case 1:
			questionType = "negativeminusnegative";
			break;
		case 2:
			questionType = "negativeminuspositive";
			break;
		case 3:
			questionType = "negativepluspositive";
			break;
		case 4:
			questionType = "negativeplusnegative";
			break;
		case 5:
			questionType = "positiveplusnegative";
			break;			
		case 6:
			questionType = "positiveminusnegative";
			break;
		}
		
		// questionType = "singleDisplacement";
		if (questionType == "negativepluspositive") {
			typeOfMath = "addpositive";
			var number = -1*(1+Math.floor(Math.random() * 12));
			var numbertwo = (1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
				return this.nodeType === 3;
			}).replaceWith(function () {
				return this.nodeValue.replace(/[0123456789.]/g, '<sub>$&</sub>');
			});
			thisAnswerWrongCuzNegative = Number(number + numbertwo)+"";

			if (score > 19) {
				document.getElementById("num1").innerHTML = "what is " + number+ " + " + numbertwo + "?"; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			} else if (score > 9) {
				document.getElementById("num1").innerHTML = "What is " + number + " + " + numbertwo + "."; // + organicCompoundName + "."; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>.?";
			} else {
				document.getElementById("num1").innerHTML = "What is " + number + " + " + numbertwo + "?"; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			...
			thisAnswerWrongCuzNegative = Number(number - numbertwo)+""; // probably needs a new message
			resetQuestionDecimals(Number(number + numbertwo));
		} else if (questionType == "negativeminuspositive") {
			typeOfMath = "subtractpositive";
			var number = -1*(1+Math.floor(Math.random() * 12));
			var numbertwo = (1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
				return this.nodeType === 3;
		...
		} else if (questionType == "negativeminusnegative") { //resetquestion
			typeOfMath = "subtractnegative";
			var number = -1*(1+Math.floor(Math.random() * 12));
			var numbertwo = -1*(1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
				return this.nodeType === 3;
			}).replaceWith(function () {
				return this.nodeValue.replace(/[0123456789.]/g, '<sub>$&</sub>');
		...
		} else if (questionType == "negativeplusnegative") { //resetquestion
			typeOfMath = "addnegative";
			var number = -1*(1+Math.floor(Math.random() * 12));
			var numbertwo = -1*(1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
				return this.nodeType === 3;
		...
		} else if (questionType == "positiveplusnegative") { //reset question
			typeOfMath = "addnegative";
			var number = 1*(1+Math.floor(Math.random() * 12));
			var numbertwo = -1*(1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
		...
		} else if (questionType == "positiveminusnegative") { //reset question
			typeOfMath = "subtractnegative";
			var number = 1*(1+Math.floor(Math.random() * 12));
			var numbertwo = -1*(1+Math.floor(Math.random() * 12));
			$('#num1 :not(script)').contents().filter(function () {
	...
	$('#submitButton').click(function () {
		...
		if (givenAnswer != null) {
			...
			if (("" + givenAnswer).toUpperCase().replace(/\s/g, '') == ("" + thisAnswer).toUpperCase().replace(/\s/g, '')) {
				...
				if (("" + givenAnswer).toUpperCase().replace(/\s/g, '') == ("" + thisAnswerWrongCuzNegative).toUpperCase().replace(/\s/g, '')) {
					if (typeOfMath=="subtractnegative")	{
						alert("The question was: "+ document.getElementById("num1").innerHTML+"\n\nYou wrote: " + givenAnswer + ". The correct answer was " + thisAnswer +". \n\nRemember, when you subtract a negative number, it is like adding a positive number. You should be moving to the right on the number line.");
					} else if (typeOfMath=="addnegative")	{
						alert("The question was: "+ document.getElementById("num1").innerHTML+"\n\nYou wrote: " + givenAnswer + ". The correct answer was " + thisAnswer +". \n\nRemember, when you add a negative number, the result is to get more negative. You should be moving to the left on the number line.");
					} else if (typeOfMath=="subtractpositive")	{
						alert("The question was: "+ document.getElementById("num1").innerHTML+"\n\nYou wrote: " + givenAnswer + ". The correct answer was " + thisAnswer +". \n\nRemember, when you subtract a positive number, the result is to get less positive. You should be moving to the left on the number line.");
					} else if (typeOfMath=="addpositive")	{
						alert("The question was: "+ document.getElementById("num1").innerHTML+"\n\nYou wrote: " + givenAnswer + ". The correct answer was " + thisAnswer +". \n\nRemember, when you add a positive number, the result is to get more positive. You should be moving to the right on the number line.");
					}
				}
				else{
				alert("The question was: "+ document.getElementById("num1").innerHTML+"\n\nYou wrote: " + givenAnswer + ". The correct answer was " + thisAnswer);

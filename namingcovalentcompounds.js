...
//end of the things to replace
	...
	var resetQuestion = function () {
		...
		var randomunitnum6 = (Math.floor(Math.random() * 8) + 1);
		if (randomunitnum6==randomunitnum5){
		while(randomunitnum6==randomunitnum5){
		randomunitnum6 = (Math.floor(Math.random() * 8) + 1);
		}
		}
		...
		var covalentArray = generateCovalentCompoundStuff(randomunitnum5, randomunitnum6);
	...
	var getCovalentSymbol=function(elementName){
		let eSymbol="";
		if (elementName=="Carbon"){
		eSymbol="C"
		}
		if (elementName=="Oxygen"){
		eSymbol="O"
		}
		if (elementName=="Nitrogen"){
		eSymbol="N"
		}
		if (elementName=="Hydrogen"){
		eSymbol="H"
		}
		if (elementName=="Chlorine"){
		eSymbol="Cl"
		}
		if (elementName=="Fluorine"){
		eSymbol="F"
		}
		if (elementName=="Iodine"){
		eSymbol="I"
		}
		if (elementName=="Hydrogen"){
		eSymbol="H"
		}
		if (elementName=="Sulfur"){
		eSymbol="S"
		}
		...
		if (elementName=="Silicon"){
		eSymbol="Si"
		}
		return eSymbol;
	}
	
	var getCovalentName = function(prefixOne, valueOne, prefixTwo, valueTwo){
		if (valueTwo=="Nitrogen"){
			valueTwo="nitride";
		}
		else if (valueTwo=="Carbon"){
			valueTwo="carbide";
		}		
		else if (valueTwo=="Oxygen"){
			valueTwo="oxide";
		}	
		...
		else if (valueTwo=="Iodine"){
			valueTwo="iodide";
		}	
		else if (valueTwo=="Sulfur"){
			valueTwo="sulfide";
		}	
		else if (valueTwo=="Fluorine"){
			valueTwo="fluoride";
		}
	...
	valueTwo="mono"+valueTwo;
	}
	}
	if (prefixOne==2){
	valueOne="di"+valueOne;
	}
	if (prefixTwo==2){
	valueTwo="di"+valueTwo;
	}
	if (prefixOne==3){
	valueOne="tri"+valueOne;
	}
	if (prefixTwo==3){
	valueTwo="tri"+valueTwo;
	}
	if (prefixOne==4){
	valueOne="tetra"+valueOne;
	}
	if (prefixTwo==4){
	valueTwo="tetra"+valueTwo;
	}
	if (prefixOne==5){
	valueOne="penta"+valueOne;
	}
	if (prefixTwo==5){
	valueTwo="penta"+valueTwo;
	}
	if (prefixOne==6){
	valueOne="hexa"+valueOne;
	}
	if (prefixTwo==6){
	valueTwo="hexa"+valueTwo;
	}
	if (prefixOne==7){
	valueOne="hepta"+valueOne;
	}
	if (prefixTwo==7){
	valueTwo="hepta"+valueTwo;
	}
	if (prefixOne==8){
	valueOne="octa"+valueOne;
	}
	if (prefixTwo==8){
	valueTwo="octa"+valueTwo;
	}
	if (prefixOne==9){
	valueOne="nona"+valueOne;
	}
	if (prefixTwo==9){
	valueTwo="nona"+valueTwo;
	}
	if (prefixOne==10){
	valueOne="deca"+valueOne;
	}
	if (prefixTwo==10){
	valueTwo="deca"+valueTwo;
	}
	
	return valueOne+" "+valueTwo;
	}
var generateCovalentCompoundStuff = function (randV1, randV2){
		let localValueOne="";
		let localValueTwo="";
		if (randV1==1){
			 localValueOne="Carbon"
		}
		if (randV2==1){
			 localValueTwo="Carbon"
		}	
		if (randV1==2){
			 localValueOne="Sulfur"
		}
		if (randV2==2){
			 localValueTwo="Sulfur"
		}	
		if (randV1==3){
			 localValueOne="Chlorine"
		}
		if (randV2==3){
			 localValueTwo="Chlorine"
		}	
		if (randV1==4){
			 localValueOne="Nitrogen"
		}
		if (randV2==4){
		...
		if (randV2==6){
			 localValueTwo="Iodine"
		}	
		if (randV1==7){
			 localValueOne="Fluorine"
		}
		if (randV2==7){
			 localValueTwo="Fluorine"
		}	
		if (randV1==8){
			 localValueOne="Bromine"
		}
		if (randV2==8){
			 localValueTwo="Bromine"
		}	
		// if (randV1==9){
			 // localValueOne="Carbon"
		// }
		...
		// if (randV2==11){
			 // localValueTwo="Carbon"
		// }		
let covArray=[localValueOne, localValueTwo];		
		return covArray;
	}

...
function findNote(e) { //Avi thinks this determines what note frequency the note is rounded to.
    if (254.285 >= e) {
        ...
        for (var r = 54; 71 >= r; r++)
            if (e > noteBorders[r][0] && e <= noteBorders[r][1]) return r; return -1
}
...
function beginAudio(e) { //Avi thinks It all begins here.
    ...
    try {
        ...
        navigator.mediaDevices.getUserMedia ? navigator.mediaDevices.getUserMedia({
            ...
            .then(function(r) {
                source = audioCtx.createMediaStreamSource(r), source.connect(analyzer), timeDomainData = new Float32Array(analyzer.fftSize), bitCounter = audioCtx.sampleRate, e ? setTimeout(function() { //Avi thinks this gets our sound from microphone
                    gauge.update({
                        units: "Play!"
...
var noteArray = [
    ...
    [48.999, "G1"],
    [51.913, "G1#"],
    [55, "A1"],  //9, Avi says this is our first note that we have audio for
    [58.27, "A1#"], //10
    [61.735, "B1"], //11
    [65.406, "C2"], //12
    [69.296, "C2#"], //13
    ...
    [116.54, "A2#"],
    [123.47, "B2"],
    [130.81, "C3"], //24 C's are always multiples of 12
    [138.59, "C3#"],
    [146.83, "D3"],
    [155.56, "D3#"],
    [164.81, "E3"],
    ...
    [932.33, "A5#"],
    [987.77, "B5"],
    [1046.5, "C6"], //Avi is not sure but he thinks this is 53
    [1108.7, "C6#"],
    [1174.7, "D6"],
    [1244.5, "D6#"],
    [1318.5, "E6"],

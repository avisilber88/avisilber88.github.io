...
if (document.getElementById("jln").selected) { //checking to see if ________ is checked
    ...
    if (document.getElementById("ez5").selected) { //checking to see if ________ is checked
        totalselected++;
		insertHTML=insertHTML+"<td style = 'vertical-align:top'><strong>Fifths:</strong> (Named 'root note' + '5' ex: C5) <br>&nbsp;1st note: The root note name <br>  &nbsp;2nd note: 7 semitones/half-steps above the root note<br><img src='C5.jpeg' style = 'width:60%; position: relative; vertical-align:bottom' alt=''></td>";
   ez5on=true;
	}
	else{
		ez5on=false;
    ...
    if (document.getElementById("ezmaj").selected) { //checking to see if ________ is checked
        totalselected++;
				insertHTML=insertHTML+"<td style = 'vertical-align:top'><strong>Majors:</strong> (Named 'root note' ex: C)<br>&nbsp;1st note: The root note name <br>  &nbsp;2nd note: 4 semitones/half-steps above the root note<br>  &nbsp;3rd note: 7 semitones/half-steps above the root note<br><img src='C.jpeg' style = 'width:60%; position: relative; bottom:0px' alt=''></td>";
		ezmajon=true;
    ...
    if (document.getElementById("ezm").selected) { //checking to see if ________ is checked
        totalselected++;
		insertHTML=insertHTML+"<td style = 'vertical-align:top'><strong>Minors:</strong> (Named 'root note' + 'm' ex: Cm) <br>&nbsp;1st note: The root note name <br>  &nbsp;2nd note: 3 semitones/half-steps above the root note<br>  &nbsp;3rd note: 7 semitones/half-steps above the root note<br><img src='Cm.jpeg' style = 'width:60%; position: relative; bottom:0px' alt=''></td>";
		ezminon=true;
    }else{
		ezminon=false;
...
async function playANote(arrayPlace) { // where we Play Notes  //important chordIsDone means we are not playing the chord. !chordIsDone means we are playing the chord or arpeggios.
    ...
    var noteStr = getNoteName(arrayPlace); // error spot 1
...
function updateTimer() {
    ...
    if (currentStep < 3) {
        ...
        if (presentationType == "words") {
            countdownMessage = " " + currentChordName;
        }

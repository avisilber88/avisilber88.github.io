...
// const wave = audioCtx.createPeriodicWave(wavetable.real, wavetable.imag); //this is a synth
...
function scheduleNote(stepNumber, nextTime) {
  ...
  notesInQueue.push({note: stepNumber, time: nextTime});//this is pushing an array including a note with the value stepNumber, and a time with a value time

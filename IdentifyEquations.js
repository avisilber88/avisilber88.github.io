...
//end of the things to replace
	...
	var resetQuestion = function () {
		...
		if (questionType == "synthesis") {
			...
			if (score > 19) {
				document.getElementById("num1").innerHTML = "classify the reaction type of the below reaction "; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
			} else if (score > 9) {
				document.getElementById("num1").innerHTML = "Classify the reaction type of the below reaction. "; // + organicCompoundName + "."; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>.?";
			} else {
				document.getElementById("num1").innerHTML = "Classify the reaction type of the below reaction "; // + organicCompoundName; // + ". <br>" + balancedFormulaArray[0] + "<sub>(s)</sub> ->  ___" + cationArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub> + ___ " + anionArray[0].replace(/[()]/g, '') + "<sup>___</sup><sub>(aq)</sub>?";
...
var setupQuestionText = function (){
if (true==false) {
			...
			if (questionType == "synthesis") {
				...
				// }
				document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + reactionArray[1] + " + " + (oxygenCoefficientAnswerWrite) + reactionArray[3] + " -> " + (catCoefficientAnswerWrite) + reactionArray[5];
				// var cationcoefficient = document.getElementById("cationcoefficient").value;
				// // var anioncoefficient = document.getElementById("anioncoefficient").value;
				// var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				// var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				...
				document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + reactionArray[5] + " -> " + (catCoefficientAnswerWrite) + reactionArray[1] + " + " + (anCoefficientAnswerWrite) + reactionArray[3];
				// var cationcoefficient = document.getElementById("cationcoefficient").value;
				// var anioncoefficient = document.getElementById("anioncoefficient").value;
				// var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				// // var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				...
				document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + organicCompoundName + "<sub></sub> + " + (oxygenCoefficientAnswerWrite) + "O<sub>2 (g)</sub>" + " -> " + (catCoefficientAnswerWrite) + ("CO<sub>2</sub>").replace(/[()]/g, '') + "<sub> (g)</sub> + " + (anCoefficientAnswerWrite) + ("H<sub>2</sub>O").replace(/[()]/g, '') + "<sub> (l)</sub>";
				// var cationcoefficient = document.getElementById("cationcoefficient").value;
				// var anioncoefficient = document.getElementById("anioncoefficient").value;
				// var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				// var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				...
				document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + balancedReactantOneFormulaArray[0] + " + " + (oxygenCoefficientAnswerWrite) + balancedReactantTwoFormulaArray[0] + " -> " + (catCoefficientAnswerWrite) + productOneFormulaAnswer[0] + " + " + (anCoefficientAnswerWrite) + productTwoFormulaAnswer[0];
				// var cationcoefficient = document.getElementById("cationcoefficient").value;
				// var anioncoefficient = document.getElementById("anioncoefficient").value;
				// var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;
				// var oxygencoefficient = document.getElementById("oxygenCoefficient").value;
				...
				// alert (oxygenCoefficient+"b");
				if (singleAnion){
				document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + balancedReactantOneFormulaArray[0] + " + " + (oxygenCoefficientAnswerWrite) + anionTwoArray[0].replace(/[()]/g, '')+"&#8322" + " -> " + (catCoefficientAnswerWrite) + productOneFormulaAnswer[0] + " + " + (anCoefficientAnswerWrite) + anionArray[0].replace(/[()]/g, '')+"&#8322";
				}
				else{
					document.getElementById("correctanswer").innerHTML = "     " + (organicCompoundCoefficientAnswerWrite) + balancedReactantOneFormulaArray[0] + " + " + (oxygenCoefficientAnswerWrite) + cationTwoArray[0] + " -> " + (catCoefficientAnswerWrite) + productOneFormulaAnswer[0] + " + " + (anCoefficientAnswerWrite) + cationArray[0];
				}
				// var cationcoefficient = document.getElementById("cationcoefficient").value;
				// var anioncoefficient = document.getElementById("anioncoefficient").value;
				// var organiccompoundcoefficient = document.getElementById("organicCompoundCoefficient").value;

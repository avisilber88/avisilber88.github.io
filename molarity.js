...
// if (exponency.substring(0,1)==="+"){
		...
		// var answerStringFinal=answerString.substring(0,eSpot)+"*10^"+exponency;
			...
			var moles = n1*10.exp(mag1)/mW;
			var molar = moles/(n2.exp(mag2));
...
var getCorrectChemicalFormula(moleculeName){
		newName="";
		randomunitnum=(Math.floor(Math.random()*6));
		if (moleculeNameculeName=="CaCl2"){
			newName="CaCl"+str.sub("2");
		}
		else if (moleculeNameculeName=="NaCl"){
			newName="CaCl"+str.sub("2");
		}
		else if (moleculeNameculeName=="C6H12O6"){
			newName="C"+str.sub("6")+"H"+str.sub("12")+"O"+str.sub("6");
		}
		else if (moleculeNameculeName=="(NH4)3N"){
			newName="(NH"+str.sub("4")+")"+str.sub("3")+"N";
		}
		else if (moleculeName=="H2SO4"){
			newName="H"+str.sub("2")+"SO"+str.sub("4");
		}
		else if (moleculeNameculeName=="KBr"){
			newName="KBr";
		}
		return newName;
}
	...
	var resetQuestion=function(){
		...
		numbertwo=(Math.floor(Math.random()*2000000000-1000000000));
...
// the below text would have generated a random unit type.
		...
		units1 = getUnit(mag1)+"grams";
		units2 = getUnit(mag2)+"Liters";
		//units1 = number+"grams";
		//units2 = numbertwo+"Liters";
		units3 = getMolaraMassText(getRandomMolecule);
